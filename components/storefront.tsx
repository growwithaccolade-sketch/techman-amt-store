...
export default function Storefront() {
  ...
  return (
    <main>
      ...
      <footer className="footer"><div className="shell footerGrid"><div><Link href="/" className="brand footerBrand"><span className="brandMark">T</span><span>TECHMAN <b>AMT</b></span></Link><p>Phones, gadgets and creator tech chosen for how people actually work, create and live.</p></div><div><b>Shop</b><a href="#shop">Phones</a><a href="#shop">Laptops</a><a href="#creator">Creator Tools</a><a href="#deals">Deals</a></div><div><b>Help</b><Link href="/cart">Your cart</Link><Link href="/checkout">Checkout</Link><span>Delivery & warranty pages coming next</span></div><div><b>Talk to us</b>{supportLink ? <a className="whatsappLink" href={supportLink} target="_blank" rel="noreferrer">Chat on WhatsApp</a> : <span>WhatsApp contact is being configured</span>}</div></div><div className="shell copyright"><span>© 2026 TechMan AMT. All rights reserved.</span><span>Built for conversion, trust and scale.</span></div></footer>
